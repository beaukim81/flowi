...
const extraTemplates: TemplateSeed[] = [
  ...
  extraTask("Therapie/afspraak", "Afspraken", "vrij", extraSteps.afspraak, 45),
  ...
  extraTask("Mee naar afspraak van ouder", "Afspraken", "vrij", extraSteps.afspraak, 45),
  ...
  extraTask("Vriendje komt spelen", "Sociaal", "vrij", extraSteps.spelen, 60),
  ...
  extraTask("Rapport", "School", "vrij", ["Neem je rapport mee.", "Bekijk het samen.", "Klaar."], 10),
  ...
  extraTask("Samen wandelen", "Familie", "vrij", extraSteps.eropuit, 30),
  extraTask("Samen spelletje doen", "Familie", "vrij", extraSteps.spelen, 30),
  extraTask("Samen lezen", "Familie", "vrij", ["Kies een boek.", "Lees of luister samen.", "Leg het boek terug."], 15),
  extraTask("Samen koken", "Familie", "vrij", ["Vraag wat je mag doen.", "Help met een stap.", "Ruim samen op."], 30),
  ...
  extraTask("Dansen", "Bewegen", "vrij", extraSteps.sport, 15),
  extraTask("Steppen", "Buiten spelen", "vrij", extraSteps.sport, 30),
  extraTask("Skaten", "Buiten spelen", "vrij", extraSteps.sport, 30),
  extraTask("Skateboarden", "Buiten spelen", "vrij", extraSteps.sport, 30),
  extraTask("Surfskaten", "Buiten spelen", "vrij", extraSteps.sport, 30),
  extraTask("Voetballen buiten", "Buiten spelen", "vrij", extraSteps.sport, 30),
  extraTask("Basketballen buiten", "Buiten spelen", "vrij", extraSteps.sport, 30),
  ...
  extraTask("Wandelen", "Buiten spelen", "vrij", extraSteps.eropuit, 30),
  ...
  extraTask("Knutselclub", "Clubs", "naSchool", extraSteps.samen, 45),
  extraTask("Theaterles", "Clubs", "naSchool", extraSteps.samen, 45),
  extraTask("Toneelclub", "Clubs", "naSchool", extraSteps.samen, 45),
  ...
  extraTask("Programmeerclub", "Clubs", "naSchool", extraSteps.samen, 45),
  extraTask("Robotica", "Clubs", "naSchool", extraSteps.samen, 45),
  extraTask("Lego-club", "Clubs", "naSchool", extraSteps.samen, 45),
  extraTask("Kookclub", "Clubs", "naSchool", extraSteps.samen, 45),
  extraTask("Natuurclub", "Clubs", "naSchool", extraSteps.samen, 45),
  extraTask("Leesclub", "Clubs", "naSchool", extraSteps.samen, 45),
  extraTask("Bibliotheekactiviteit", "Clubs", "vrij", extraSteps.samen, 45),
  extraTask("Jeugdclub", "Clubs", "naSchool", extraSteps.samen, 60),
  extraTask("Geloofsactiviteit", "Clubs", "vrij", extraSteps.samen, 60),
  extraTask("Kinderkoor", "Clubs", "naSchool", extraSteps.samen, 45),

  extraTask("Skiën", "Sport", "vrij", extraSteps.sport, 60),
  extraTask("Judo", "Sport", "naSchool", extraSteps.sport, 45),
  extraTask("Karate", "Sport", "naSchool", extraSteps.sport, 45),
  extraTask("Taekwondo", "Sport", "naSchool", extraSteps.sport, 45),
  extraTask("Krav maga", "Sport", "naSchool", extraSteps.sport, 45),
  extraTask("Kickboksen", "Sport", "naSchool", extraSteps.sport, 45),
  extraTask("Boksen", "Sport", "naSchool", extraSteps.sport, 45),
  extraTask("Aikido", "Sport", "naSchool", extraSteps.sport, 45),
  extraTask("Jiujitsu", "Sport", "naSchool", extraSteps.sport, 45),
  ...
  extraTask("Tafeltennis", "Sport", "naSchool", extraSteps.sport, 45),
