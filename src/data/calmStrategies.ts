...
export const calmStrategies: CalmStrategy[] = [
  ...
  make("Pak iets zachts", ["verdrietig"], ["knuffel"], "🧸", "Pak iets zachts. Houd het dicht tegen je aan."),
  make("Kies dichtbij of ruimte", ["verdrietig"], ["evenAlleen", "praatMetOuder"], "🤍", "Kies: wil je iemand dichtbij, of even ruimte?"),
  ...
  make("Vraag een knuffel", ["verdrietig"], ["knuffel"], "💜", "Vraag: mag ik een knuffel? Hulp vragen is knap."),
